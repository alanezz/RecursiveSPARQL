...
public class QueryExecutionFactory
{
    ...
    static public QueryExecution create(Query query, Dataset dataset)
    {
    	...
    	Dataset copyDS = DatasetFactory.create(dataset);
    	...
    	/*if(query.isRecursive)
    	{
    		...
    		{
    			//ingresar como dataset
    			RecursiveNode.execQueryWithoutUnion(dataset, (query.ConstructRecursiveQueries).get(i), (query.ConstructRecursiveQueries).get(i).recursiveURI);
    	...
    	dataset = DatasetFactory.create(copyDS);
        return retQE;
